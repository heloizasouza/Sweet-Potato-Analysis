...
ggplot(data = climate, mapping = aes(x = Data, y = `Prec.(mm)`)) + 
  geom_line() + 
...
ggplot(data = climate[-c(37:52),], mapping = aes(x = Data, y = `Rad. global (MJ/m2 d)`)) + 
...
ggplot(data = climate, mapping = aes(x = Data, y = `T med (0º)`)) + 
  geom_line() + 
  scale_x_date(date_breaks = "4 week", date_labels = "%b/%Y") + 
  geom_vline(xintercept = as.Date('2024-04-12'), colour = 'red', linetype = 'dashed') +
...
ggplot(data = climate, mapping = aes(x = Data, y = `T max 0º C`)) + 
  geom_line() + 
  scale_x_date(date_breaks = "4 week", date_labels = "%b/%Y") + 
  geom_vline(xintercept = as.Date('2024-04-12'), colour = 'red', linetype = 'dashed') +
...
ggplot(data = climate, mapping = aes(x = Data, y = `T min (0 º)`)) + 
  geom_line() + 
  scale_x_date(date_breaks = "4 week", date_labels = "%b/%Y") + 
  geom_vline(xintercept = as.Date('2024-04-12'), colour = 'red', linetype = 'dashed') +
...
ggplot(data = climate, mapping = aes(x = Data, y = `UR med (%)`)) + 
  geom_line() + 
  scale_x_date(date_breaks = "4 week", date_labels = "%b/%Y") + 
  geom_vline(xintercept = as.Date('2024-04-12'), colour = 'red', linetype = 'dashed') +
